...
let fn_glPrimitiveBoundingBox!: Deno.UnsafeFnPointer<typeof def_glPrimitiveBoundingBox>;
...
export function load(proc: (name: string) => Deno.PointerValue): void {
  ...
  fn_glBlendBarrier = new Deno.UnsafeFnPointer(proc("glBlendBarrier"), def_glBlendBarrier);
  ...
  fn_glPrimitiveBoundingBox = new Deno.UnsafeFnPointer(proc("glPrimitiveBoundingBox"), def_glPrimitiveBoundingBox);
