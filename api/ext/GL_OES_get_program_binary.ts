...
let fn_glGetProgramBinaryOES!: Deno.UnsafeFnPointer<
  typeof def_glGetProgramBinaryOES
>;
...
export function load(proc: (name: string) => Deno.PointerValue): void {
  fn_glGetProgramBinaryOES = new Deno.UnsafeFnPointer(
    proc("glGetProgramBinaryOES"),
    def_glGetProgramBinaryOES,
  );
  fn_glProgramBinaryOES = new Deno.UnsafeFnPointer(
    proc("glProgramBinaryOES"),
    def_glProgramBinaryOES,
  );
}
