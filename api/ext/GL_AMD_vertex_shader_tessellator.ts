...
/// Enums
export const SAMPLER_BUFFER_AMD = 0x9001;
export const INT_SAMPLER_BUFFER_AMD = 0x9002;
export const UNSIGNED_INT_SAMPLER_BUFFER_AMD = 0x9003;
export const TESSELLATION_MODE_AMD = 0x9004;
export const TESSELLATION_FACTOR_AMD = 0x9005;
export const DISCRETE_AMD = 0x9006;
export const CONTINUOUS_AMD = 0x9007;

/// Commands

export const def_glTessellationFactorAMD = {
  parameters: ["f32"],
  result: "void",
} as const;
...
export function TessellationFactorAMD(
  ...
  fn_glTessellationFactorAMD.call(
    factor,
  );
}

export const def_glTessellationModeAMD = {
  parameters: ["u32"],
  result: "void",
} as const;
