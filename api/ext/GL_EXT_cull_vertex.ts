...
/// Enums
export const CULL_VERTEX_EXT = 0x81aa;
export const CULL_VERTEX_EYE_POSITION_EXT = 0x81ab;
export const CULL_VERTEX_OBJECT_POSITION_EXT = 0x81ac;

/// Commands

export const def_glCullParameterdvEXT = {
...
export function CullParameterdvEXT(
  ...
  fn_glCullParameterdvEXT.call(
    pname,
    bufferToFFI(params),
  );
}

export const def_glCullParameterfvEXT = {
  parameters: ["u32", "buffer"],
  result: "void",
} as const;
