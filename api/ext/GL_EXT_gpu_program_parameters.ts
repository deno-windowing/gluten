...
export const def_glProgramEnvParameters4fvEXT = {
...
export function ProgramEnvParameters4fvEXT(
  ...
  fn_glProgramEnvParameters4fvEXT.call(
    target,
    index,
    count,
    bufferToFFI(params),
...
export const def_glProgramLocalParameters4fvEXT = {
  parameters: ["u32", "u32", "i32", "buffer"],
  result: "void",
} as const;
...
export function ProgramLocalParameters4fvEXT(
  ...
  fn_glProgramLocalParameters4fvEXT.call(
    target,
    index,
    count,
    bufferToFFI(params),
