...
export const TEXTURE_BUFFER_BINDING_EXT = 0x8c2a;
...
export const TEXTURE_BUFFER_OFFSET_ALIGNMENT_EXT = 0x919f;
...
export const TEXTURE_BUFFER_OFFSET_EXT = 0x919d;
export const TEXTURE_BUFFER_SIZE_EXT = 0x919e;
...
export const def_glTexBufferRangeEXT = {
  parameters: ["u32", "u32", "u32", "buffer", "isize"],
  result: "void",
} as const;

let fn_glTexBufferRangeEXT!: Deno.UnsafeFnPointer<typeof def_glTexBufferRangeEXT>;
...
export function load(proc: (name: string) => Deno.PointerValue): void {
  fn_glTexBufferEXT = new Deno.UnsafeFnPointer(proc("glTexBufferEXT"), def_glTexBufferEXT);
  fn_glTexBufferRangeEXT = new Deno.UnsafeFnPointer(proc("glTexBufferRangeEXT"), def_glTexBufferRangeEXT);
}
