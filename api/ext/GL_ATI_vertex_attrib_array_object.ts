...
export const def_glVertexAttribArrayObjectATI = {
  parameters: ["u32", "i32", "u32", "u8", "i32", "u32", "u32"],
  result: "void",
} as const;
...
export function VertexAttribArrayObjectATI(
  ...
  fn_glVertexAttribArrayObjectATI.call(
    index,
    size,
    type,
    normalized,
...
export const def_glGetVertexAttribArrayObjectfvATI = {
...
export function GetVertexAttribArrayObjectfvATI(
  ...
  fn_glGetVertexAttribArrayObjectfvATI.call(
    index,
    pname,
    bufferToFFI(params),
  );
...
export const def_glGetVertexAttribArrayObjectivATI = {
  parameters: ["u32", "u32", "buffer"],
  result: "void",
} as const;
...
export function GetVertexAttribArrayObjectivATI(
  ...
  fn_glGetVertexAttribArrayObjectivATI.call(
    index,
    pname,
    bufferToFFI(params),
  );
