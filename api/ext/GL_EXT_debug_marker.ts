...
export const def_glInsertEventMarkerEXT = {
...
export function InsertEventMarkerEXT(
  ...
  fn_glInsertEventMarkerEXT.call(
    length,
    bufferToFFI(marker),
  );
}

export const def_glPushGroupMarkerEXT = {
  parameters: ["i32", "buffer"],
  result: "void",
} as const;
...
export function PushGroupMarkerEXT(
  ...
  fn_glPushGroupMarkerEXT.call(
    length,
    bufferToFFI(marker),
  );
}

export const def_glPopGroupMarkerEXT = {
  parameters: [],
  result: "void",
} as const;
