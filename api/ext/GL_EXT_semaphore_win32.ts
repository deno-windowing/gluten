...
export const HANDLE_TYPE_D3D12_FENCE_EXT = 0x9594;
export const D3D12_FENCE_VALUE_EXT = 0x9595;

/// Commands

export const def_glImportSemaphoreWin32HandleEXT = {
...
export function ImportSemaphoreWin32HandleEXT(
  ...
  fn_glImportSemaphoreWin32HandleEXT.call(
    semaphore,
    handleType,
    bufferToFFI(handle),
  );
...
export const def_glImportSemaphoreWin32NameEXT = {
  parameters: ["u32", "u32", "buffer"],
  result: "void",
} as const;
...
export function ImportSemaphoreWin32NameEXT(
  ...
  fn_glImportSemaphoreWin32NameEXT.call(
    semaphore,
    handleType,
    bufferToFFI(name),
  );
