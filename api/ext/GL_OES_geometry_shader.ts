...
let fn_glFramebufferTextureOES!: Deno.UnsafeFnPointer<
  typeof def_glFramebufferTextureOES
>;
...
export function load(proc: (name: string) => Deno.PointerValue): void {
  fn_glFramebufferTextureOES = new Deno.UnsafeFnPointer(
    proc("glFramebufferTextureOES"),
    def_glFramebufferTextureOES,
  );
}
