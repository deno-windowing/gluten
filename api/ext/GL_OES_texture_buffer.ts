...
let fn_glTexBufferRangeOES!: Deno.UnsafeFnPointer<typeof def_glTexBufferRangeOES>;
...
export function load(proc: (name: string) => Deno.PointerValue): void {
  fn_glTexBufferOES = new Deno.UnsafeFnPointer(proc("glTexBufferOES"), def_glTexBufferOES);
  fn_glTexBufferRangeOES = new Deno.UnsafeFnPointer(proc("glTexBufferRangeOES"), def_glTexBufferRangeOES);
}
