...
export const def_glQueryCounterEXT = {
  parameters: ["u32", "u32"],
  result: "void",
} as const;

let fn_glQueryCounterEXT!: Deno.UnsafeFnPointer<typeof def_glQueryCounterEXT>;

export function QueryCounterEXT(
  id: GLuint,
  target: GLenum,
): void {
  fn_glQueryCounterEXT.call(
    id,
    target,
  );
}
...
export const def_glGetQueryObjectivEXT = {
  parameters: ["u32", "u32", "buffer"],
  result: "void",
} as const;

let fn_glGetQueryObjectivEXT!: Deno.UnsafeFnPointer<
  typeof def_glGetQueryObjectivEXT
>;

export function GetQueryObjectivEXT(
  id: GLuint,
  pname: GLenum,
  params: Buffer,
): void {
  fn_glGetQueryObjectivEXT.call(
    id,
    pname,
    bufferToFFI(params),
  );
...
let fn_glGetQueryObjectuivEXT!: Deno.UnsafeFnPointer<
  typeof def_glGetQueryObjectuivEXT
>;
...
export const def_glGetQueryObjecti64vEXT = {
  parameters: ["u32", "u32", "buffer"],
  result: "void",
} as const;
...
export function GetQueryObjecti64vEXT(
  ...
  fn_glGetQueryObjecti64vEXT.call(
    id,
    pname,
    bufferToFFI(params),
  );
...
export const def_glGetQueryObjectui64vEXT = {
  parameters: ["u32", "u32", "buffer"],
  result: "void",
} as const;
...
export function GetQueryObjectui64vEXT(
  ...
  fn_glGetQueryObjectui64vEXT.call(
    id,
    pname,
    bufferToFFI(params),
  );
...
export const def_glGetInteger64vEXT = {
  parameters: ["u32", "buffer"],
  result: "void",
} as const;

let fn_glGetInteger64vEXT!: Deno.UnsafeFnPointer<typeof def_glGetInteger64vEXT>;

export function GetInteger64vEXT(
  pname: GLenum,
  data: Buffer,
): void {
  fn_glGetInteger64vEXT.call(
    pname,
    bufferToFFI(data),
  );
}
...
export function load(proc: (name: string) => Deno.PointerValue): void {
  fn_glGenQueriesEXT = new Deno.UnsafeFnPointer(
    proc("glGenQueriesEXT")!,
    def_glGenQueriesEXT,
  );
  fn_glDeleteQueriesEXT = new Deno.UnsafeFnPointer(
    proc("glDeleteQueriesEXT")!,
    def_glDeleteQueriesEXT,
  );
  fn_glIsQueryEXT = new Deno.UnsafeFnPointer(
    proc("glIsQueryEXT")!,
    def_glIsQueryEXT,
  );
  fn_glBeginQueryEXT = new Deno.UnsafeFnPointer(
    proc("glBeginQueryEXT")!,
    def_glBeginQueryEXT,
  );
  fn_glEndQueryEXT = new Deno.UnsafeFnPointer(
    proc("glEndQueryEXT")!,
    def_glEndQueryEXT,
  );
  fn_glQueryCounterEXT = new Deno.UnsafeFnPointer(
    proc("glQueryCounterEXT")!,
    def_glQueryCounterEXT,
  );
  fn_glGetQueryivEXT = new Deno.UnsafeFnPointer(
    proc("glGetQueryivEXT")!,
    def_glGetQueryivEXT,
  );
  fn_glGetQueryObjectivEXT = new Deno.UnsafeFnPointer(
    proc("glGetQueryObjectivEXT")!,
    def_glGetQueryObjectivEXT,
  );
  fn_glGetQueryObjectuivEXT = new Deno.UnsafeFnPointer(
    proc("glGetQueryObjectuivEXT")!,
    def_glGetQueryObjectuivEXT,
  );
  ...
  fn_glGetInteger64vEXT = new Deno.UnsafeFnPointer(
    proc("glGetInteger64vEXT")!,
    def_glGetInteger64vEXT,
  );
}
