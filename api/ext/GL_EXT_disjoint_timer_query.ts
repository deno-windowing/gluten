...
let fn_glGetQueryObjectivEXT!: Deno.UnsafeFnPointer<typeof def_glGetQueryObjectivEXT>;
...
export function load(proc: (name: string) => Deno.PointerValue): void {
  ...
  fn_glQueryCounterEXT = new Deno.UnsafeFnPointer(proc("glQueryCounterEXT"), def_glQueryCounterEXT);
  fn_glGetQueryivEXT = new Deno.UnsafeFnPointer(proc("glGetQueryivEXT"), def_glGetQueryivEXT);
  fn_glGetQueryObjectivEXT = new Deno.UnsafeFnPointer(proc("glGetQueryObjectivEXT"), def_glGetQueryObjectivEXT);
  ...
  fn_glGetInteger64vEXT = new Deno.UnsafeFnPointer(proc("glGetInteger64vEXT"), def_glGetInteger64vEXT);
}
