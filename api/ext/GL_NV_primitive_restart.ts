...
/// Enums
export const PRIMITIVE_RESTART_NV = 0x8558;
export const PRIMITIVE_RESTART_INDEX_NV = 0x8559;

/// Commands

export const def_glPrimitiveRestartNV = {
  parameters: [],
  result: "void",
} as const;
...
export const def_glPrimitiveRestartIndexNV = {
  parameters: ["u32"],
  result: "void",
} as const;
...
export function PrimitiveRestartIndexNV(
  ...
  fn_glPrimitiveRestartIndexNV.call(
    index,
  );
}
