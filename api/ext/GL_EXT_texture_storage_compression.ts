...
let fn_glTexStorageAttribs2DEXT!: Deno.UnsafeFnPointer<
...
let fn_glTexStorageAttribs3DEXT!: Deno.UnsafeFnPointer<
  typeof def_glTexStorageAttribs3DEXT
>;
...
export function load(proc: (name: string) => Deno.PointerValue): void {
  fn_glTexStorageAttribs2DEXT = new Deno.UnsafeFnPointer(
    proc("glTexStorageAttribs2DEXT"),
    def_glTexStorageAttribs2DEXT,
  );
  fn_glTexStorageAttribs3DEXT = new Deno.UnsafeFnPointer(
    proc("glTexStorageAttribs3DEXT"),
    def_glTexStorageAttribs3DEXT,
  );
}
