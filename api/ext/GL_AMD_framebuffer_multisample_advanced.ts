...
/// Enums
export const RENDERBUFFER_STORAGE_SAMPLES_AMD = 0x91b2;
export const MAX_COLOR_FRAMEBUFFER_SAMPLES_AMD = 0x91b3;
export const MAX_COLOR_FRAMEBUFFER_STORAGE_SAMPLES_AMD = 0x91b4;
export const MAX_DEPTH_STENCIL_FRAMEBUFFER_SAMPLES_AMD = 0x91b5;
export const NUM_SUPPORTED_MULTISAMPLE_MODES_AMD = 0x91b6;
export const SUPPORTED_MULTISAMPLE_MODES_AMD = 0x91b7;

/// Commands

export const def_glRenderbufferStorageMultisampleAdvancedAMD = {
...
export function RenderbufferStorageMultisampleAdvancedAMD(
  ...
  fn_glRenderbufferStorageMultisampleAdvancedAMD.call(
    target,
    samples,
    storageSamples,
    internalformat,
...
export const def_glNamedRenderbufferStorageMultisampleAdvancedAMD = {
  parameters: ["u32", "i32", "i32", "u32", "i32", "i32"],
  result: "void",
} as const;
...
export function NamedRenderbufferStorageMultisampleAdvancedAMD(
  ...
  fn_glNamedRenderbufferStorageMultisampleAdvancedAMD.call(
    renderbuffer,
    samples,
    storageSamples,
    internalformat,
