...
/// Enums
export const TEXTURE_RANGE_LENGTH_APPLE = 0x85b7;
export const TEXTURE_RANGE_POINTER_APPLE = 0x85b8;
export const TEXTURE_STORAGE_HINT_APPLE = 0x85bc;
export const STORAGE_PRIVATE_APPLE = 0x85bd;
export const STORAGE_CACHED_APPLE = 0x85be;
export const STORAGE_SHARED_APPLE = 0x85bf;

/// Commands

export const def_glTextureRangeAPPLE = {
...
export const def_glGetTexParameterPointervAPPLE = {
...
export function GetTexParameterPointervAPPLE(
  ...
  fn_glGetTexParameterPointervAPPLE.call(
    target,
    pname,
    bufferToFFI(params),
  );
