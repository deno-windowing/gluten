...
export const def_glEGLImageTargetTexStorageEXT = {
...
export function EGLImageTargetTexStorageEXT(
  ...
  fn_glEGLImageTargetTexStorageEXT.call(
    target,
    bufferToFFI(image),
...
export const def_glEGLImageTargetTextureStorageEXT = {
  parameters: ["u32", "buffer", "buffer"],
  result: "void",
} as const;
...
export function EGLImageTargetTextureStorageEXT(
  ...
  fn_glEGLImageTargetTextureStorageEXT.call(
    texture,
    bufferToFFI(image),
    bufferToFFI(attrib_list),
  );
