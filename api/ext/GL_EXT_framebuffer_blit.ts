...
/// Enums
export const READ_FRAMEBUFFER_EXT = 0x8ca8;
export const DRAW_FRAMEBUFFER_EXT = 0x8ca9;
export const DRAW_FRAMEBUFFER_BINDING_EXT = 0x8ca6;
export const READ_FRAMEBUFFER_BINDING_EXT = 0x8caa;
