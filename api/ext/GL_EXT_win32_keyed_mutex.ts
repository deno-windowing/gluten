...
export const def_glAcquireKeyedMutexWin32EXT = {
...
export function AcquireKeyedMutexWin32EXT(
  ...
  return fn_glAcquireKeyedMutexWin32EXT.call(
    memory,
    Deno.UnsafePointer.value(key),
    timeout,
  );
}

export const def_glReleaseKeyedMutexWin32EXT = {
  parameters: ["u32", "u64"],
  result: "u8",
} as const;
...
export function ReleaseKeyedMutexWin32EXT(
  ...
  return fn_glReleaseKeyedMutexWin32EXT.call(
    memory,
    Deno.UnsafePointer.value(key),
  );
}
