...
export const def_glCreateProgressFenceNVX = {
  parameters: [],
  result: "u32",
} as const;
...
export const def_glSignalSemaphoreui64NVX = {
...
export function SignalSemaphoreui64NVX(
  ...
  semaphoreArray: Buffer,
  fenceValueArray: Buffer,
): void {
  fn_glSignalSemaphoreui64NVX.call(
    signalGpu,
    fenceObjectCount,
    bufferToFFI(semaphoreArray),
    bufferToFFI(fenceValueArray),
  );
}

export const def_glWaitSemaphoreui64NVX = {
  parameters: ["u32", "i32", "buffer", "buffer"],
  result: "void",
} as const;
...
export function WaitSemaphoreui64NVX(
  ...
  fn_glWaitSemaphoreui64NVX.call(
    waitGpu,
    fenceObjectCount,
    bufferToFFI(semaphoreArray),
    bufferToFFI(fenceValueArray),
...
export const def_glClientWaitSemaphoreui64NVX = {
...
export function ClientWaitSemaphoreui64NVX(
  ...
  fn_glClientWaitSemaphoreui64NVX.call(
    fenceObjectCount,
    bufferToFFI(semaphoreArray),
    bufferToFFI(fenceValueArray),
  );
