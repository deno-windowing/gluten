...
let fn_glTexPageCommitmentARB!: Deno.UnsafeFnPointer<typeof def_glTexPageCommitmentARB>;
...
export function load(proc: (name: string) => Deno.PointerValue): void {
  fn_glTexPageCommitmentARB = new Deno.UnsafeFnPointer(proc("glTexPageCommitmentARB")!, def_glTexPageCommitmentARB);
}
