...
/// Enums
export const FRAMEBUFFER_FLIP_Y_MESA = 0x8bbb;

/// Commands

export const def_glFramebufferParameteriMESA = {
...
export function FramebufferParameteriMESA(
  ...
  fn_glFramebufferParameteriMESA.call(
    target,
    pname,
    param,
  );
...
export const def_glGetFramebufferParameterivMESA = {
...
export function GetFramebufferParameterivMESA(
  ...
  fn_glGetFramebufferParameterivMESA.call(
    target,
    pname,
    bufferToFFI(params),
  );
