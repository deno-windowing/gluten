...
let fn_glTextureFoveationParametersQCOM!: Deno.UnsafeFnPointer<typeof def_glTextureFoveationParametersQCOM>;
...
export function load(proc: (name: string) => Deno.PointerValue): void {
  fn_glTextureFoveationParametersQCOM = new Deno.UnsafeFnPointer(proc("glTextureFoveationParametersQCOM"), def_glTextureFoveationParametersQCOM);
}
