...
export function load(proc: (name: string) => Deno.PointerValue): void {
  fn_glTexImage3DEXT = new Deno.UnsafeFnPointer(proc("glTexImage3DEXT"), def_glTexImage3DEXT);
  fn_glTexSubImage3DEXT = new Deno.UnsafeFnPointer(proc("glTexSubImage3DEXT"), def_glTexSubImage3DEXT);
}
