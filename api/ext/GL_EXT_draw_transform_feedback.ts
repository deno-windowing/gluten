...
export const def_glDrawTransformFeedbackEXT = {
  parameters: ["u32", "u32"],
  result: "void",
} as const;
...
export function DrawTransformFeedbackEXT(
  ...
  fn_glDrawTransformFeedbackEXT.call(
    mode,
    id,
  );
}

export const def_glDrawTransformFeedbackInstancedEXT = {
...
export function DrawTransformFeedbackInstancedEXT(
  ...
  fn_glDrawTransformFeedbackInstancedEXT.call(
    mode,
    id,
    instancecount,
  );
