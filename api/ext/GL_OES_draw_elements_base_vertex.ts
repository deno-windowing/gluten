...
export const def_glDrawElementsBaseVertexOES = {
...
export function DrawElementsBaseVertexOES(
  ...
  fn_glDrawElementsBaseVertexOES.call(
    mode,
    count,
    type,
    bufferToFFI(indices),
...
export const def_glDrawRangeElementsBaseVertexOES = {
...
export function DrawRangeElementsBaseVertexOES(
  ...
  fn_glDrawRangeElementsBaseVertexOES.call(
    mode,
    start,
    end,
    count,
...
export const def_glDrawElementsInstancedBaseVertexOES = {
...
export function DrawElementsInstancedBaseVertexOES(
  ...
  fn_glDrawElementsInstancedBaseVertexOES.call(
    mode,
    count,
    type,
    bufferToFFI(indices),
