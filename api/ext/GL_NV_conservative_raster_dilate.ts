...
/// Enums
export const CONSERVATIVE_RASTER_DILATE_NV = 0x9379;
export const CONSERVATIVE_RASTER_DILATE_RANGE_NV = 0x937a;
export const CONSERVATIVE_RASTER_DILATE_GRANULARITY_NV = 0x937b;

/// Commands

export const def_glConservativeRasterParameterfNV = {
  parameters: ["u32", "f32"],
  result: "void",
} as const;
...
export function ConservativeRasterParameterfNV(
  ...
  fn_glConservativeRasterParameterfNV.call(
    pname,
    value,
  );
}
