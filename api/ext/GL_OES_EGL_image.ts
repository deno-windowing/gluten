...
export const def_glEGLImageTargetTexture2DOES = {
...
export function EGLImageTargetTexture2DOES(
  ...
  fn_glEGLImageTargetTexture2DOES.call(
    target,
    bufferToFFI(image),
  );
}

export const def_glEGLImageTargetRenderbufferStorageOES = {
  parameters: ["u32", "buffer"],
  result: "void",
} as const;
...
export function EGLImageTargetRenderbufferStorageOES(
  ...
  fn_glEGLImageTargetRenderbufferStorageOES.call(
    target,
    bufferToFFI(image),
  );
}
