...
export function load(proc: (name: string) => Deno.PointerValue): void {
  fn_glClipPlanefIMG = new Deno.UnsafeFnPointer(proc("glClipPlanefIMG"), def_glClipPlanefIMG);
  fn_glClipPlanexIMG = new Deno.UnsafeFnPointer(proc("glClipPlanexIMG"), def_glClipPlanexIMG);
}
