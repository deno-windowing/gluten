...
export const def_glFramebufferPixelLocalStorageSizeEXT = {
  parameters: ["u32", "i32"],
  result: "void",
} as const;
...
export function FramebufferPixelLocalStorageSizeEXT(
  ...
  fn_glFramebufferPixelLocalStorageSizeEXT.call(
    target,
    size,
  );
}

export const def_glGetFramebufferPixelLocalStorageSizeEXT = {
  parameters: ["u32"],
  result: "i32",
} as const;
...
export function GetFramebufferPixelLocalStorageSizeEXT(
  ...
  return fn_glGetFramebufferPixelLocalStorageSizeEXT.call(
    target,
  );
}

export const def_glClearPixelLocalStorageuiEXT = {
...
export function ClearPixelLocalStorageuiEXT(
  ...
  fn_glClearPixelLocalStorageuiEXT.call(
    offset,
    n,
    bufferToFFI(values),
  );
