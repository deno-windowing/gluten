...
/// Enums
export const QUADS_FOLLOW_PROVOKING_VERTEX_CONVENTION_EXT = 0x8e4c;
export const FIRST_VERTEX_CONVENTION_EXT = 0x8e4d;
export const LAST_VERTEX_CONVENTION_EXT = 0x8e4e;
export const PROVOKING_VERTEX_EXT = 0x8e4f;

/// Commands

export const def_glProvokingVertexEXT = {
  parameters: ["u32"],
  result: "void",
} as const;
