...
export function load(proc: (name: string) => Deno.PointerValue): void {
  fn_glStartTilingQCOM = new Deno.UnsafeFnPointer(proc("glStartTilingQCOM"), def_glStartTilingQCOM);
  fn_glEndTilingQCOM = new Deno.UnsafeFnPointer(proc("glEndTilingQCOM"), def_glEndTilingQCOM);
}
