...
/// Enums
export const QUERY_WAIT_NV = 0x8e13;
export const QUERY_NO_WAIT_NV = 0x8e14;
export const QUERY_BY_REGION_WAIT_NV = 0x8e15;
export const QUERY_BY_REGION_NO_WAIT_NV = 0x8e16;

/// Commands

export const def_glBeginConditionalRenderNV = {
  parameters: ["u32", "u32"],
  result: "void",
} as const;
...
export function BeginConditionalRenderNV(
  ...
  fn_glBeginConditionalRenderNV.call(
    id,
    mode,
  );
}

export const def_glEndConditionalRenderNV = {
  parameters: [],
  result: "void",
} as const;
