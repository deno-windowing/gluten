...
/// Enums
export const SPRITE_SGIX = 0x8148;
export const SPRITE_MODE_SGIX = 0x8149;
export const SPRITE_AXIS_SGIX = 0x814a;
export const SPRITE_TRANSLATION_SGIX = 0x814b;
export const SPRITE_AXIAL_SGIX = 0x814c;
export const SPRITE_OBJECT_ALIGNED_SGIX = 0x814d;
export const SPRITE_EYE_ALIGNED_SGIX = 0x814e;

/// Commands

export const def_glSpriteParameterfSGIX = {
  parameters: ["u32", "f32"],
  result: "void",
} as const;
...
export function SpriteParameterfSGIX(
  ...
  fn_glSpriteParameterfSGIX.call(
    pname,
    param,
  );
}

export const def_glSpriteParameterfvSGIX = {
...
export function SpriteParameterfvSGIX(
  ...
  fn_glSpriteParameterfvSGIX.call(
    pname,
    bufferToFFI(params),
  );
}

export const def_glSpriteParameteriSGIX = {
  parameters: ["u32", "i32"],
  result: "void",
} as const;
...
export function SpriteParameteriSGIX(
  ...
  fn_glSpriteParameteriSGIX.call(
    pname,
    param,
  );
}

export const def_glSpriteParameterivSGIX = {
  parameters: ["u32", "buffer"],
  result: "void",
} as const;
...
export function SpriteParameterivSGIX(
  ...
  fn_glSpriteParameterivSGIX.call(
    pname,
    bufferToFFI(params),
  );
}
