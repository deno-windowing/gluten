...
export const def_glClearTexImageEXT = {
  parameters: ["u32", "i32", "u32", "u32", "buffer"],
  result: "void",
} as const;

let fn_glClearTexImageEXT!: Deno.UnsafeFnPointer<typeof def_glClearTexImageEXT>;

export function ClearTexImageEXT(
  texture: GLuint,
  level: GLint,
  format: GLenum,
  type: GLenum,
