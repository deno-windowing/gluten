...
/// Enums
export const SCISSOR_TEST_EXCLUSIVE_NV = 0x9555;
export const SCISSOR_BOX_EXCLUSIVE_NV = 0x9556;

/// Commands

export const def_glScissorExclusiveNV = {
...
export const def_glScissorExclusiveArrayvNV = {
...
export function ScissorExclusiveArrayvNV(
  ...
  fn_glScissorExclusiveArrayvNV.call(
    first,
    count,
    bufferToFFI(v),
  );
