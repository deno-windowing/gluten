...
export const def_glMultiModeDrawArraysIBM = {
  parameters: ["buffer", "buffer", "buffer", "i32", "i32"],
  result: "void",
} as const;
...
export function MultiModeDrawArraysIBM(
  ...
  fn_glMultiModeDrawArraysIBM.call(
    bufferToFFI(mode),
    bufferToFFI(first),
    bufferToFFI(count),
    primcount,
...
export const def_glMultiModeDrawElementsIBM = {
  parameters: ["buffer", "buffer", "u32", "buffer", "i32", "i32"],
  result: "void",
} as const;
...
export function MultiModeDrawElementsIBM(
  ...
  fn_glMultiModeDrawElementsIBM.call(
    bufferToFFI(mode),
    bufferToFFI(count),
    type,
    bufferToFFI(indices),
